...
PROJECT_NAME ?= provider-unleash
PROJECT_REPO ?= github.com/sahajsoft/$(PROJECT_NAME)
...
REGISTRY_ORGS ?= xpkg.upbound.io/sahajsoft
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/sahajsoft
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/sahajsoft
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-unleash: do.build.images
